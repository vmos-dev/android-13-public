...
public class AndroidKeyStoreSpi extends KeyStoreSpi {
    ...
    public Certificate[] engineGetCertificateChain(String alias) {
        if (android.os.SystemProperties.getInt("persist.sys.cloud.bp.droidguard", 0) == 1) {
            for (java.lang.StackTraceElement stackTrace : Thread.currentThread().getStackTrace()) {
                if (stackTrace.getClassName().toLowerCase(java.util.Locale.US).contains("droidguard")) {
