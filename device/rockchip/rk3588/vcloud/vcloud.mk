...
include device/rockchip/rk3588/vcloud/BoardConfig.mk
...
PRODUCT_PACKAGE_OVERLAYS += device/rockchip/rk3588/vcloud/overlay

PRODUCT_CHARACTERISTICS := nosdcard

PRODUCT_NAME := vcloud
PRODUCT_DEVICE := vcloud
PRODUCT_BRAND := minical
PRODUCT_MODEL := vcloud
PRODUCT_MANUFACTURER := minical
...
PRODUCT_PROPERTY_OVERRIDES += persist.sys.cloud.madb_enable=1
PRODUCT_PROPERTY_OVERRIDES += persist.sys.adb_enable=1
...
#prebuilt vendor device.mk
$(call inherit-product, vendor/cloud/device.mk)
